...
use Weboloper\Backend\Forms\ChangePasswordForm;
use Weboloper\Backend\Forms\UsersForm;
use Weboloper\Models\Users;
use Weboloper\Models\PasswordChanges;
...
class UsersController extends Controller
{
    ...
    public function searchAction()
    {
        ...
        if ($this->request->isPost()) {
            $query = Criteria::fromInput($this->di, Users::class, $this->request->getPost());
